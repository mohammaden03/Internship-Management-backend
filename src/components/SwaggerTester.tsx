  ...
  const endpoints: EndpointDef[] = [
    // Auth
    {
      ...
      responseExample: {
        ...
        data: {
          accessToken: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxIiwibmF0aW9uYWxDb2RlIjoiMDA5ODc2NTQzMiIsInJvbGUiOiJBRE1JTiJ9...',
          refreshToken: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.refresh_token_payload...',
          tokenType: 'Bearer',
          role: activeRole,
          user: {
            id: activeRole === 'ADMIN' ? 1 : activeRole === 'PROFESSOR' ? 2 : 4,
          ...
          items: [
            {
              ...
              user: { firstName: 'محمد', lastName: 'احمدی', email: 'm.ahmadi@semnan.ac.ir', role: 'STUDENT' },
            },
            {
              id: 2,
              ...
              degreeLevel: 'کارشناسی',
              user: { firstName: 'علی', lastName: 'رضایی', email: 'a.rezaei@semnan.ac.ir', role: 'STUDENT' },
            },
          ],
          meta: { totalItems: 4, itemCount: 2, itemsPerPage: 10, totalPages: 1, currentPage: 1 },
        },
      },
    },
    {
      ...
      responseExample: {
        ...
        data: {
          ...
          major: 'مهندسی نرم‌افزار',
          degreeLevel: 'کارشناسی',
          user: { firstName: 'محمد', lastName: 'احمدی', email: 'm.ahmadi@semnan.ac.ir', phoneNumber: '09121234567', role: 'STUDENT' },
        },
      },
    },
          ...
          items: [
            {
              ...
              status: 'ACTIVE',
              student: { studentNumber: '400105432', user: { firstName: 'محمد', lastName: 'احمدی', role: 'STUDENT' } },
              company: { name: 'شرکت فناوران هوشمند', supervisorName: 'مهندس آرش طاهری' },
            },
          ],
    ...
    // Companies
    {
      ...
      tag: 'Companies',
      method: 'GET',
      path: '/api/companies?search=فناوران&page=1&limit=10',
    ...
    },
    {
      ...
      responseExample: {
        ...
        data: { id: 5, name: 'هلدینگ هزاردستان', city: 'تهران' },
      },
    },
    ...
    // Internship Requests
    {
      ...
      defaultBody: {
        ...
        description: 'گذراندن دوره رسمی ۲۴۰ ساعته کارآموزی در واحد فنی شرکت فناوران هوشمند تحت نظارت تیم مهندسی.',
        startDate: '2024-06-21T00:00:00.000Z',
      ...
      responseExample: {
        ...
        data: {
          ...
          status: 'PENDING',
          title: 'کارآموزی توسعه بک‌اند با NestJS و معماری میکروسرویس',
          company: { name: 'شرکت فناوران هوشمند' },
    ...
    },
    {
      ...
      tag: 'Internship Requests',
      method: 'PATCH',
      path: '/api/internship-requests/1/status',
      ...
      responseExample: {
        ...
        data: {
          ...
          internship: {
            ...
            professor: { user: { firstName: 'محمد', lastName: 'رضایی' } },
          },
        },
      },
    },
    ...
    // Weekly Reports
    {
      ...
      defaultBody: {
        ...
        skillsLearned: 'CI/CD, Docker, Health Check API',
        challenges: 'محدودیت منابع رانر که با کش کردن لایه‌های داکر حل شد.',
        description: 'شرح تفصیلی فعالیت‌های هفته پنجم کارآموزی در شرکت فناوران هوشمند.',
      },
      responseExample: {
        statusCode: 201,
        message: 'گزارش هفتگی شماره ۵ با موفقیت ارسال شد و به استاد ناظر اطلاع داده شد',
        data: { id: 9, weekNumber: 5, status: 'SUBMITTED' },
      },
    },
    {
          ...
          items: [
            {
              ...
              internship: { student: { user: { firstName: 'محمد', lastName: 'احمدی' } } },
            },
          ],
    ...
    },
    {
      ...
      tag: 'Weekly Reports',
      method: 'PATCH',
      path: '/api/weekly-reports/1/review',
      ...
      responseExample: {
        ...
        data: { id: 1, status: 'APPROVED', professorComment: 'تسلط دانشجو بر ابزارهای تست...' },
      },
    },
    ...
    },
    {
      ...
      responseExample: {
        headers: {
          'content-disposition': 'attachment; filename="ahmadi_intro_letter.pdf"',
    ...
    // Notifications
    {
      ...
      responseExample: {
        ...
        data: {
          items: [
            { id: 1, title: 'تأیید درخواست کارآموزی', message: 'درخواست شما در شرکت دیجی‌کالا تأیید شد.', isRead: false },
            { id: 2, title: 'تأیید گزارش هفتگی ۳', message: 'گزارش شما توسط استاد ناظر تأیید گردید.', isRead: true },
          ],
          unreadCount: 1,
        },
      },
    ...
    // Activity Logs
    {
      ...
      responseExample: {
        ...
        data: {
          items: [
            { id: 1, action: 'ورود به سامانه به عنوان مدیر ارشد سیستم', createdAt: new Date().toISOString() },
            { id: 2, action: 'تأیید درخواست کارآموزی شماره ۱ و تخصیص استاد ناظر', createdAt: new Date().toISOString() },
          ],
          meta: { totalItems: 6, currentPage: 1 },
        },
      },
